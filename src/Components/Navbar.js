        ...
        <nav className="bg-primary shadow-lg">
            <div className="container px-4 py-4 flex justify-between items-center">
                ...
                <div className={`w-full lg:items-end md:flex md:items-end md:space-x-6 ${isOpen ? 'block' : 'hidden'}`}>
                    ...
                    <Link to="/Profile" className="block text-white mt-4 md:mt-0 hover:text-secondary transition duration-300">Profile</Link>
                    ...
                    <Link to="/CheckOut" className="block text-start text-white mt-4 md:mt-0 hover:text-secondary transition duration-300">Check Out</Link>
